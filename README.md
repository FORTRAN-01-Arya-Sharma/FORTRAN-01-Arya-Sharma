...
<h3 align="center">Software Architect • 3D Web Systems • AI Engineering</h3>
...
> **Architecture:** Hardware-accelerated 3D ecosystem built with R3F. Implements Draco mesh compression and math-driven damping for consistent 60FPS on tiered devices.  
> [**Live Preview**](https://portfolio-with-ai-assistant.vercel.app) • [**Source Hub**](https://github.com/FORTRAN-01-Arya-Sharma/PortfolioWithAIAssistant)

### 🔹 AshStar — AI-Powered Gamified SaaS
> **Intelligence:** Multi-model failover logic using Google Gemini API. Engineered a 'Neural Memory' MongoDB schema linking 1,000+ session data points.  
> [**Live Preview**](https://ash-star-with-ai-assistant.vercel.app) • [**Source Hub**](https://github.com/FORTRAN-01-Arya-Sharma/AshSTARWithAIAssistant)

### 🔹 AshFit — Decoupled E-commerce Platform
> **Optimization:** Production-grade architecture with <160ms TTFB. Features automated inventory syncing and secure JWT/RBAC protocols.  
> [**Live Preview**](https://ash-fit.vercel.app) • [**Source Hub**](https://github.com/FORTRAN-01-Arya-Sharma/AshFIT)

---

<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=28&duration=3000&pause=800&color=00F72D&center=true&vCenter=true&width=900&lines=System_Status:+Online;Software+Architect;LeetCode+Knight+1700%2B;Architecting+Future+Systems" />
</p>
